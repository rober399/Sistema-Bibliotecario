...
function Header()
{
    ...
    $this->Cell(190,20,'Listado de todos los prestamos' ,0,0,'C');
    ...
    $this->Cell(28,10,  'Fecha prestamo', 1, 0, 'C', 0);
    $this->Cell(28,10,  'Fecha devolucion', 1, 0, 'C', 0);
    $this->Cell(26,10,  'Usuario', 1, 0, 'C', 0);
...
while($row = $consulta->fetch_assoc()){
    ...
    $pdf->Cell(28,10, $row['fechaPrestamo'], 1, 0, 'C', 0);
    $pdf->Cell(28,10, $row['fechaEntrega'], 1, 0, 'C', 0);
    $pdf->Cell(26,10, $row['adminNombre'].$row['adminApellido'], 1, 0, 'C', 0);
