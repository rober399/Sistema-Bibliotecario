...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
           ...
           <div class="full-box page-header">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="../CREATE/CrearLector.php" style="border-color: blue;"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar Lector</a>
                    </li>
         ...
         $sql_register = mysqli_query($mysqli, "SELECT COUNT(*) as total_registros FROM usuarios");
            ...
            $query=mysqli_query($mysqli,"SELECT * FROM usuarios WHERE estatus=1 ORDER BY idUsuario ASC LIMIT $desde , $por_pagina");
            mysqli_close($mysqli);
            ...
            if($resultado>0){
                while ($data= mysqli_fetch_array($query)) {
                        ...
                        <tr class="text-center"> 
                            ...
                            <td><?php echo $data['apellidoUs']; ?></td>
                            <td><?php echo $data['sexo']; ?></td>
                            <td><?php echo $data['tipoUs']; ?></td>
                            <td><a href="../UPDATE/Update-Reader.php?id=<?php echo $data['idUsuario']; ?>"><i class="fas fa-exchange-alt"></i></a></td>
                        </tr>
             </tbody>
              <?php
                 }
