    ...
    <main class="full-box main-container">
       ...
       <section class="full-box nav-lateral">
        ...
        <section class="full-box page-content">
           ...
           <div class="full-box page-header">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="../CREATE/CrearAdmin.php" style="border-color: blue;"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar Administrador</a>
                    </li>
         ...
         $sql_register = mysqli_query($mysqli, "SELECT COUNT(*) as total_registros FROM administradores");
            ...
            $query=mysqli_query($mysqli,"SELECT a.idAdmin,a.DUI,a.adminNombre,a.adminApellido,a.sexo,a.email,a.fechaRegistro,r.descripcion FROM administradores a INNER JOIN rol r ON a.rol=r.id ORDER BY a.idAdmin ASC LIMIT $desde , $por_pagina");
            mysqli_close($mysqli);
            ...
            if($resultado>0){
                while ($data= mysqli_fetch_array($query)) {
                        ...
                        <tr class="text-center"> 
                            ...
                            <td><?php echo $data['adminNombre']; ?></td>
                            <td><?php echo $data['adminApellido']; ?></td>
                            <td><?php echo $data['sexo']; ?></td>
                            <td><?php echo $data['email']; ?></td>
                            <td><?php echo $data['fechaRegistro']; ?></td>
                            <td><?php echo $data['descripcion']; ?></td>
                            <td><a href="../UPDATE/ActualizarAdmin.php?id=<?php echo $data['idAdmin']; ?>"><i class="fas fa-exchange-alt"></i></a></td>
                        </tr>
             </tbody>
              <?php
                 }
