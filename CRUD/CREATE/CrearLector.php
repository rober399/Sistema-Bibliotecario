				...
				<fieldset>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="nombreUs" class="bmd-label text-dark">N° de identificación</label><br>
									<input required type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ 0-9 ]{1,40}" class="form-control" name="carnet" placeholder="Digite Numero de Identificación" id="nombreUs"  required>
									<div class="invalid-feedback">
										Falta identificador
									</div>
								</div>
							...
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input required type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="nombreUs" placeholder="Digite Nombre del Lector" id="nombreUs"  required>
									<div class="invalid-feedback">
										Falta el Nombre
									</div>
								</div>
							...
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input required type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="apellidoUs" placeholder="Digite Apellido del Lector" id="apellidoUs" required>
									<div class="invalid-feedback">
										Falta el Apellido
									</div>
								</div>
