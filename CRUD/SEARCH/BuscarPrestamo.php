...
<body>
    ...
    <main class="full-box main-container">
       ...
       <section class="full-box nav-lateral">
        ...
        <section class="full-box page-content">
          ...
          <form action="BuscarLibro.php" method="POST">
                ...
                <div class="form-group">
                    <label for="numEjemplares" class="bmd-label text-dark">Buscar Prestamo</label><br>
        ...
        $sql_register = mysqli_query($mysqli, "SELECT COUNT(*) AS total_registros FROM prestamos p INNER JOIN libros l ON p.idLibroPrestamo=l.idLibro INNER JOIN usuarios u ON p.idUsuarioPrestamo=u.idUsuario INNER JOIN administradores a ON p.idAdminPrestamo=a.idAdmin WHERE (l.titulo LIKE '%$busqueda%'
            )");
            ...
            if($resultado>0){
                while ($data= mysqli_fetch_array($query)) {
                        ...
                        <tr class="text-center"> 
                            ...
                            <td><?php echo $data['estadoPrestamo']; ?></td>
